 ...
 *
 * ES6 module implementation of cycle-accurate MC6809 emulator.
 * The 6809 is the most advanced 8-bit CPU with dual stacks and sophisticated addressing modes.
 *
 * Features:
 * - Enhanced registers: A, B, D (16-bit A:B), X, Y (16-bit index), S, U (dual stacks)
 * - Direct Page register (DP) for optimized zero-page addressing
 * - 8 condition code flags: E F H I N Z V C
 * - 13+ addressing modes with PostByte encoding
 * - Advanced instructions: LEA, TFR, EXG, MUL, SEX, PSH/PUL with register masks
 *
 * @module 6809
 */
