/**
 * KIM-1 Monitor ROM Data
 *
 * Two 1 KB ROM images from the original MOS Technology KIM-1 single-board computer.
 * Both chips are MCS 6530 RRIOT (RAM/ROM/I/O/Timer) devices.
 *
 * Memory map:
 *   ROM_003  →  0x1800–0x1BFF  (6530-003, secondary ROM — TTY / tape routines)
 *   ROM_002  →  0x1C00–0x1FFF  (6530-002, primary monitor ROM)
 *   ROM_002  →  0xFC00–0xFFFF  (mirror — holds 6502 reset/IRQ/NMI vectors)
 *
 * The last 6 bytes of ROM_002 (offsets 0x3FA–0x3FF) are the hardware vectors:
 *   0x3FA/0x3FB  NMI  vector → 0x1C00
 *   0x3FC/0x3FD  RESET vector → 0x1C4F
 *   0x3FE/0x3FF  IRQ  vector → 0x1C00
 */

// eslint-disable-next-line spaced-comment
/** @type {Uint8Array} 6530-003 ROM — mapped at 0x1800–0x1BFF */
export const ROM_003 = new Uint8Array([
  ...
  // end-of-ROM jump targets (last 6 bytes, offsets 0x3FA–0x3FF)
  0x6B, 0x1A, 0x6B, 0x1A, 0x6B, 0x1A,
]);

/** @type {Uint8Array} 6530-002 ROM — mapped at 0x1C00–0x1FFF and mirrored at 0xFC00–0xFFFF */
export const ROM_002 = new Uint8Array([
