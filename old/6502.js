...
immediateByte = function() {
	return byteAt(pc);
},

zeroPageAddr = function() {return byteAt(pc);},
zeroPageXAddr = function() {return 255&(x+byteAt(pc));},
zeroPageYAddr = function()  {	return 255&(y+byteAt(pc));},
indirectXAddr = function()  {	return wordAt(255&(byteAt(pc)+x));},
indirectYAddr = function()  {	if (addcycles) {
...
absoluteAddr = function()  {return wordAt(pc);},
...
i08 = function() { flags |=32; /*fix*/ stPush(flags); },
...
step = function() {
	...
	pc &=0xffff;
	var time = cycletime[instructCode]+excycles;
  T+=time; 
  if (ticks) ticks(time);
  return time; 
